...
| Tipo            | Conjunto                        | +Usado  |Sigla|
|-----------------|---------------------------------| ------- | ------- 
| Alfanumerico    | CHAR, VARCHAR, TEXT             | VARCHAR | TEXT
| Numero          | INT, BIGINT, SMALLINT           | INT | NUMBER
| Decimal         | DECIMAL, FLOAT, NUMERIC (c,p)   | DECIMAL | DECIMAL
| Data / Hora     | DATE, TIME, DATETIME, TIMESTEMP | DATE | DATE / TIME / TIMESTAMP
| Lógico          | BIT (0/1), BOOLEAN, CHAR(1)     | AMBOS | LOGIC
| Estrutural      | BLOB, JSON                      | JSON | JSON
| Binário (image) | BLOB, BYTE                   | BLOB | BYTE
